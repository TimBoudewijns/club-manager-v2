<?php
/**
 * Club Team Details partial - Read-only view for club teams
 */
?>
<!-- Club Team Details Section -->
<div x-show="selectedClubTeam && isViewingClubTeam" x-transition:enter="transition ease-out duration-300"
