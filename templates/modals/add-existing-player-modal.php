    ...
    <div class="fixed inset-0 overflow-y-auto">
        ...
        <div class="flex items-center justify-center min-h-full p-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden"
                 ...
                 @click.stop>
                <!-- Modal inner content with scroll -->
                <div class="max-h-[90vh] overflow-y-auto">
                    <!-- Header -->
                    <div class="sticky top-0 z-10 bg-gradient-to-r from-orange-500 to-orange-600 p-6 text-white">
                        <h3 class="font-bold text-2xl">Add Existing Player</h3>
                        <p class="text-orange-100 mt-1">Search and add an existing player to <span x-text="selectedTeam?.name"></span></p>
                    </div>
                    </div>
