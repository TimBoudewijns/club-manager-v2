    ...
    <div class="modal-container">
        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl max-w-2xl w-full"
            ...
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 p-4 md:p-6 text-white">
                <h3 class="font-semibold text-xl">Add Existing Player</h3>
                ...
                <div class="form-control w-full mb-6">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            class="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 w-full bg-gray-50 border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 rounded-lg pl-10"
                            autocomplete="off"
                            autocorrect="off"
                            autocapitalize="off"
                            spellcheck="false"
