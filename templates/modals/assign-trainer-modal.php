        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden"
            ...
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold text-base">Assign Trainer</h3>
                ...
                <form @submit.prevent="assignTrainerToTeam($event)" class="p-6">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-3">
                        ...
                        <button type="submit" 
                                ...
                                class="btn bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 border-0 rounded-lg px-8 shadow-lg order-1 sm:order-2 disabled:opacity-50 disabled:cursor-not-allowed"
