                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div class="bg-white rounded-lg p-4 shadow-sm">
                                    ...
                                    <p class="font-medium text-gray-900" x-text="modalViewingPlayer?.email"></p>
                                </div>
                                <div class="bg-white rounded-lg p-4 shadow-sm">
                                    <p class="text-sm text-gray-500">Birth Date</p>
                                    <p class="font-medium text-gray-900" x-text="modalViewingPlayer?.birth_date"></p>
                                </div>
                            </div>
                            
                            <!-- Notes -->
                            <div x-show="modalViewingPlayer?.notes" class="bg-white rounded-lg p-4 shadow-sm">
                                <p class="text-sm text-gray-500 mb-2">Notes</p>
                                <p class="text-gray-900" x-text="modalViewingPlayer?.notes"></p>
                            </div>
