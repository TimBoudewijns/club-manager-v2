                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm mt-0.5">Manage players across your teams</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                            <div>
                                ...
                                <p class="text-gray-500 text-sm mt-1">Teams you manage directly</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <template x-for="team in myTeams" :key="team.id">
                                <div @click="selectTeam(team)" 
                                     class="bg-white rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all duration-200 cursor-pointer overflow-hidden group relative">
                                    <!-- My Team Badge -->
                                    <div class="absolute top-4 right-4 bg-gray-100 text-gray-600 px-2.5 py-1 rounded-md text-xs font-medium">
                                        My Team
                                    </div>
                                    <div class="p-6">
                                        <div class="flex items-start justify-between mb-4">
                                            <h4 class="text-lg font-semibold text-gray-900 group-hover:text-gray-700 transition-colors" x-text="team.name"></h4>
                                        </div>
                                        <div class="space-y-2">
                                        ...
                                        <div class="mt-4 pt-4 border-t border-gray-100">
                                            <span class="text-xs text-gray-400">Click to manage players</span>
                                        </div>
                                    </div>
                                </div>
                            </template>
